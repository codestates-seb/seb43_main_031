...
export default async function getBoards({ searchText, selectedGu, selectedDong, sortType }) {
  ...
  const url = `${process.env.REACT_APP_BASE_URL}/boards?${selectedGuSearchQuery}${selectedDongSearchQuery}${searchTextQuery}${sortTypeQuery}&sortDirection=DESC`;
  try {
