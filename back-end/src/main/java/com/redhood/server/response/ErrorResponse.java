...
public class ErrorResponse {
    ...
    public static ExceptionStatus exceptionStatus(ExceptionCode exceptionCode) {
        return new ExceptionStatus(exceptionCode.getStatus(), exceptionCode.getMessage());
    }

    public static ExceptionStatus exceptionStatus(HttpStatus httpStatus) {
        return new ExceptionStatus(httpStatus.value(), httpStatus.getReasonPhrase());
    }
    ...
    public static class ExceptionStatus {
        ...
        public ExceptionStatus(int status, String message) {
            this.status = status;
            this.message = message;
        }
    }
